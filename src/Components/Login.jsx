    ...
    <div className='m-auto shadow-lg p-10 max-w-sm mt-10 h-[calc(100vh-200px)] bg-white rounded-md'>
        ...
        <div className='my-5'>
          <form action="" onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-4'>
              <label htmlFor="" className='block font-bold text-gray-800'>Email: </label>
              <input 
              type="email" 
              id='email' 
            ...
            <div className='flex items-baseline justify-between'>
              <button className='bg-blue-800 py-2 px-5 font-bold text-white mt-5 rounded-md'>Log In</button>
          ...
          <p className='mt-8 text-sm'>Don't have an accout yet? Please <span className='text-blue-500'>
